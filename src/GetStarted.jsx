    ...
    <div className="App">
      <header className="conversation" style={{ display:"flex", flexDirection:"row-reverse", justifyContent:"space-around"}}>
        <div className="Questions" style={{ display:"flex", flexDirection:"column", alignItems:"flex-end"}}>
          <div className="greetings" style={{ display:"flex", flexDirection:"column", alignItems:"flex-end", position:"relative"}}>
            <img src={ChatBox} alt="chatbox" style={{ position:'relative' }} />
            <h5 style={{ position:'absolute',top:'10px',left:'5%', margin:0, zIndex:'10'}}>hi there!</h5>
          </div>
          <div className="1stquestion">
            ...
            <h5 style={{ position:"absolute", bottom:"18%", left:"5%", margin:0, fontSize:"15px" }}>before we start, what’s the screen<br />size that we gonna create for?</h5>
          </div>
        </div>
        <div className="Answers" style={{ display:"flex", flexDirection:"column", alignItems:"flex-start",}}>
          <div className="1stanswer">
            ...
            <h5 style={{ position:"absolute", bottom:"515px", left:"14%", fontSize:"18px"}}> Pick a width (px):</h5>
            <input type="number" id="width" name="width" min="0" value={width} onChange={handleWidthChange} style={{ position:"absolute", bottom:"516px", left:"14%"}}/>
          </div>
          <div className="2ndanswer">
            <svg xmlns="http://www.w3.org/2000/svg" width="308" height="70" viewBox="0 0 308 70" fill="none">
              <path d="M13.3906 53.225C13.3906 65.1622 5.79688 67.6728 2 67.4359C7.41055 71.9834 19.6792 65.5411 25.1372 61.7516H295.644C304.757 61.7516 307.272 56.0672 307.391 53.225V12.724C307.391 2.20793 302.407 0.999997 295.644 1H25.1372C12.6075 1 13.3906 7.03963 13.3906 12.724V53.225Z" fill="#D9D9D9" stroke="black"/>
            </svg>
            <h5 style={{ position:"absolute", bottom:"47.5%", left:"14%", fontSize:"18px"}}> Pick a height (px):</h5>
            <input type="number" id="height" name="width" min="0" value={height} onChange={handleHeightChange} style={{ position:"absolute", bottom:"47.5%", left:"14%"}}/>
          </div>
        <div style={{ display:'flex', flexDirection:'column', alignItems:'flex-end', width:'100%', marginTop:'20px'}}>
          <Link to='/' className="next" style={{ pointerEvents: isNextDisabled ? 'none' : 'auto'}}>Next</Link>
        </div>
